        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p class="dismiss-link"><strong><a href="?lawyer_landing_page_admin_notice=1"><?php esc_html_e( 'Dismiss', 'lawyer-landing-page' ); ?></a></strong></p>
                </div>
            </div>
        </div>
    <?php }
...
function lawyer_landing_page_update_admin_notice(){
    if ( isset( $_GET['lawyer_landing_page_admin_notice'] ) && $_GET['lawyer_landing_page_admin_notice'] = '1' ) {
