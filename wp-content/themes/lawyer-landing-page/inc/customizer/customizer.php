...
function lawyer_landing_page_customizer_scripts() {
    $array = array( 
        ...
        'flushit'    => __( 'Successfully Flushed!','lawyer-landing-page' ),
        'nonce'      => wp_create_nonce('ajax-nonce')
    );
    wp_enqueue_style( 'lawyer-landing-page-customize-style',get_template_directory_uri().'/inc/css/customize.css', '',LAWYER_LANDING_PAGE_THEME_VERSION );
    wp_enqueue_script( 'lawyer-landing-page-customize', get_template_directory_uri() . '/inc/js/customize.js', array( 'jquery' ), LAWYER_LANDING_PAGE_THEME_VERSION, true );
    wp_localize_script( 'lawyer-landing-page-customize', 'lawyer_landing_page_cdata', $array );
}
